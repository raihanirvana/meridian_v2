  ...
  .object({
    ...
    screening: z
      .object({
        ...
        detailRequestWindowMs: z.number().int().positive().default(900_000),
        detailCooldownAfter429Ms: z.number().int().positive().default(900_000),
        requireDetailForDeploy: z.boolean().default(true),
        allowSnapshotOnlyWatch: z.boolean().default(true),
