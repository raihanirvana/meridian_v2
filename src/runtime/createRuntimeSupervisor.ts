...
export function createRuntimeSupervisor(
  ...
  const baseScreeningPolicy: ScreeningPolicy = {
    ...
    ...(input.config.screening.minPriceChange5mPct === undefined
      ? {}
      : { minPriceChange5mPct: input.config.screening.minPriceChange5mPct }),
    ...(input.config.screening.minPriceChange1hPct === undefined
      ? {}
      : { minPriceChange1hPct: input.config.screening.minPriceChange1hPct }),
    ...
    maxTopHolderPct: input.config.screening.maxTopHolderPct ?? 35,
    maxBotHolderPct: input.config.screening.maxBotHolderPct ?? 20,
    maxBundleRiskPct: input.config.screening.maxBundleRiskPct ?? 20,
    maxWashTradingRiskPct: input.config.screening.maxWashTradingRiskPct ?? 20,
